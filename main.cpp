...
int main(int argc, char **argv) {
    ...
    if (FLAGS_task == writeStr) {
        ...
        printf("MFDedup --task=restore --RestorePath=[where the restored file locates] --RestoreRecipe=[which version to restore(1 ~ no. of the last version)] --MaxVersion=[How many versions exists in the system]\n");
